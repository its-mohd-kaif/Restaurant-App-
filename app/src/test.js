...
import img2 from "./images/waffles-chocolate-with.jpg";
import img3 from "./images/kanghodong-bbq-16.jpg";
import img4 from "./images/KatzLine.0.jpg";
import img5 from "./images/roberta-s-pizza-marina-bay-sands-data.jpg";
import img6 from "./images/HomeTown.jpeg";
import img7 from "./images/download.jpeg";
import img8 from "./images/dutch.jpg";
import img9 from "./images/image (1).jpg";
import img10 from "./images/Casa-Enrique.jpg";
export const Data = {
  restaurants: [
    {
      id: 1,
